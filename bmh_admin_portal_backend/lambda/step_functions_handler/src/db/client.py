...
class DBClient():
    ...
    def set_status(self, workspace_request_id, status, email=None):
        ...
        """
        return self._update_single_attribute('request_status', status, workspace_request_id, email)
    ...
    def set_account_id(self, workspace_request_id, account_id, email=None):
        ...
        """
        return self._update_single_attribute('account_id', account_id, workspace_request_id, email)
    ...
    def get_email_by_workspace_request_id(self, workspace_request_id):
        ...
        try:
            ...
            if e.response['Error']['Code'] == 'ConditionalCheckFailedException':
                raise InvalidWorkspaceRequestIdException(f"Could find workspace request {workspace_request_id}")
            else:
                raise e
    ...
    def _update_single_attribute(self, attribute_name, attribute_value, workspace_request_id, email=None):
