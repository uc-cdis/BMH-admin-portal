...
class EmailClient():
    ...
    def send_email(self, data):
        ...
        try:
            response = ses.send_templated_email(
                ...
                TemplateData = "{ \"name\":\""+ name +"\", \"SITE\": \"" + site_settings["site"] +"\", \"ACCOUNT_TYPE\":\""+workspace_type+"\", \"SITE_URL\":\""+ site_settings["url"] +"\",\"DOC_LINK\":\""+ site_settings["doc_link"]+ "\" }"
            )
        except Exception as e:
    ...
    def get_site_data(self):
        ...
        if email_domain == "planx-pla.net":
            ...
            return {"site": "HEAL", "url": "https://healdata.org", "doc_link":"https://healdata.org/dashboard/Public/documentation/index.html#Workspaces"}
        else:
