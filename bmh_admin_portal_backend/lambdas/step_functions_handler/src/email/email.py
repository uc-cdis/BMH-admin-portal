...
class EmailClient:
    ...
    def create_email_template(self, template_name):
        try:
            ses.create_template(Template=self._get_template_body(template_name))
    ...
    def email_template(self, template_name):
        try:
            ...
            if e.response["Error"]["Code"] == "TemplateDoesNotExist":
                self.create_email_template(template_name)
            else:
                raise e

    def _get_template_body(self, template_name):
        return {
            "TemplateName": template_name,
            "SubjectPart": "{{template_name}} account update",
