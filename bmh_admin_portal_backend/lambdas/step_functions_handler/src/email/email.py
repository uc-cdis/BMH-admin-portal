...
class EmailClient:
    def __init__(self):
        self.template_name = "welcome_email_template"
    ...
    def send_email(self, data):
        ...
        name = data.get("scientific_poc", f"{site_settings['site']} Workspace User")
    ...
    def get_site_data(self):
        ...
        if email_domain == "planx-pla.net":
            return {
                ...
                "doc_link": "https://uc-cdis.github.io/BRH-documentation/09-workspace_page/",
            }
