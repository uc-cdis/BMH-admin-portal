...
def _get_param(param_name):
    ...
    try:
        ...
        logger.error(f"Error retrieving {param_name} from SSM Parameter Store. "
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Add a verified test user to AWS Cognito UserPool for BMH backend')
    parser.add_argument('-e', '--email', required=True, help="Username for the test user.")
