        ...
        if(requestApproved === "true"){
          ...
          <div>
                <Form onSubmit={handleRequest} keyField='directpay_request_information'>
                  ...
                  <Col>
                  <Form.Check type="checkbox" name="attestation" label={`By filling out this form below, I consent to be invoiced by OCC the amount of $${(directpaylimit)}  to provision that amount of compute for my workspace. If this value is incorrect, please contact OCC (billing@occ-data.org) to update your request amount.`} required />
                  </Col>
                  </Form.Row>
                  <br></br>
